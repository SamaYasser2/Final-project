...
import'./Selectedarabic.css'
import selectTe from'../../Assets/Images/teacher_1.jpg'
import { Link } from 'react-router-dom'
export default function Selectedarabic() {
  return<>
     <section id="About-teacher" >
        ...
        <div className="about-img col-md-5 ">
            <div className="left">
        <img src={selectTe}  alt="Teacher"/>
        </div>
        </div>
        <div className="about-content col-md-7">
            <div className="right mt-5 mt-md-0">
        <h3 className=" abt-teacher fw-bolder display-6 "> Arabic Teacher</h3>
       ...
       <div className="row">
        ...
        <Link to="/ClassroomArabic" id='btn1' className=" btn rounded-pill"> Enroll in course</Link>
